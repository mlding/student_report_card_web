...
/******/ 	var hotCurrentHash = "4886d380b0021ec03c00"; // eslint-disable-line no-unused-vars
...
const StudentModule = __webpack_require__(1);
...
$('#alterModal').on('show.bs.modal', function() {
  ...
  $("#alterModal #inputName").val(name);
  $("#alterModal #inputNum").val(num);
  $("#alterModal #ethnic").val(ethnic);
  $("#alterModal #inputClass").val(klass);
  $("#alterModal #inputMandarinScore").val(mandarinScore);
  $("#alterModal #inputMathScore").val(mathScore);
  $("#alterModal #inputEnglishScore").val(englishScore);
  $("#alterModal #inputProgrammingScore").val(programmingScore);
});
