...
/******/ 	var hotCurrentHash = "a7157064f5afbe8acd02"; // eslint-disable-line no-unused-vars
...
const StudentModule = __webpack_require__(2);
...
$("#add form").submit(function(e) {
  ...
  const studentInfo = {
    ...
    ethnic: inputData[2],
    klass: inputData[3],
    mandarinScore: inputData[4],
    mathScore: inputData[5],
    englishScore: inputData[6],
    programmingScore: inputData[7]
  }
  if(isInputStrValid) {
    localStorage.setItem(studentInfo.num, JSON.stringify(studentInfo));
    $("form").trigger("reset");
  } else {
    $(".btns").before(`<div class="warning">请按正确的格式输入要打印的学生的学号（格式： 学号, 学号,...)</div>`);
  }
});
...
$(".all-tab").click(function(e) {
  ...
  $(".table").innerHTML = studentsInfoStr;
});
